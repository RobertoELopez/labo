...
kdataset_salida  <- "paquete_premium_ext_721_prueba1.csv.gz"
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , mvr_mprom_ctarjeta_visa_debitos_automaticos  := trx_quarter  / ctarjeta_visa_debitos_automaticos								  
