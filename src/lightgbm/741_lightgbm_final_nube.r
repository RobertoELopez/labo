...
kprefijo       <- "KA741"
ksemilla_azar  <-  777863  #Aqui poner la propia semilla
kdataset       <- "./datasets/paquete_premium_ext_721_prueba2.csv.gz"

#donde entrenar
kfinal_mes_desde    <- 201201      #mes desde donde entreno
...
kmax_bin           <- 31
klearning_rate     <- 0.0637382021892117
knum_iterations    <- 151
knum_leaves        <- 567
kmin_data_in_leaf  <- 14647
kfeature_fraction  <- 0.536840525502339
